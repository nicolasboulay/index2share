...
&create("r1",3);
$r = `cd r1 ; time (../../index2share > /dev/null) ; ls -Rs | tee ../test1.txt`;
&check($r,"72509c08a2e68d9a50804cf5a3294c6fbad06432");
$r = `cd r1 ; ../../index2share -n > /dev/null ; ls -Rs`;
&check($r,"72509c08a2e68d9a50804cf5a3294c6fbad06432");
...
`rm -rf r1`;
&create("r1",3);
$r = `time (../index2share r1 > /dev/null); diff -r r1 tmp/ref1/r1 | tee test1rel.txt`;
&check($r,"da39a3ee5e6b4b0d3255bfef95601890afd80709");
$r = `(../index2share -n r1 > /dev/null); diff -r r1 tmp/ref1/r1 | tee test1rel.txt`;
&check($r,"da39a3ee5e6b4b0d3255bfef95601890afd80709");

print "Single basic run with relative path : ./r1";
`rm -rf r1`;
&create("r1",3);
$r = `time (../index2share ./r1 > /dev/null); diff -r r1 tmp/ref1/r1 |tee test1rel2.txt`;
&check($r,"da39a3ee5e6b4b0d3255bfef95601890afd80709");
$r = `time (../index2share -n ./r1 > /dev/null); diff -r r1 tmp/ref1/r1 |tee test1rel2.txt`;
&check($r,"da39a3ee5e6b4b0d3255bfef95601890afd80709");
...
$r = `time (../index2share \`pwd\`/r1 > ../test1abs.txt); diff -r r1 tmp/ref1/r1`;
&check($r,"da39a3ee5e6b4b0d3255bfef95601890afd80709");
$r = `time (../index2share -n \`pwd\`/r1 > ../test1abs.txt); diff -r r1 tmp/ref1/r1`;
&check($r,"da39a3ee5e6b4b0d3255bfef95601890afd80709");

print "Check that running 2 times on the same dir, nothing change, except list ";
`cp -rp r1/ r1_copy/`; 
`cd r1_copy/; time ../../index2share -n`;
$r = `diff -r r1_copy r1 | tee test2a.txt`;
&check($r, "da39a3ee5e6b4b0d3255bfef95601890afd80709");
`cd r1_copy/; time ../../index2share`;
$r = `diff -r r1_copy r1 | tee test2b.txt`;
&check($r, "04088a404ecd140258b1cfc1ccb1fe766cda93a7");

print "Complete recopy checking\n";
`mkdir r2; cp -rp r1/list/* r2/ ; cd r2/; time ../../index2share`;
...
`cd r2 ; ../../index2share -n; export OCAMLPARAM=b; time ../../index2share --trace`;
...
`rm -rf r3`;
`cd r2 ; ../../index2share -n ;time ../../index2share | tee ../test5.txt`;
$r = `ls -R r2`;
